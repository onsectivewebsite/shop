...
async function getStats() {
  const [
    ...
    prisma.review.count({ where: { isHidden: false, reports: { some: {} } } }).catch(() => 0),
  ...
  return (
    <div className="p-8">
      ...
      <div className="mt-8 grid gap-4 sm:grid-cols-2 lg:grid-cols-5">
        ...
        <QueueCard label="Flagged reviews" value={stats.flaggedReviews} href="/dashboard/reviews" />
      </div>
      ...
      <div className="mt-3 flex flex-wrap gap-2">
        ...
        <Pill href="/dashboard/campaigns">Email campaigns</Pill>
